            ...
            <ul class="meta-list justify-content-center mb--10">
                <li class="list-item">
                    <div class="author-thumbnail">
                        <img src="{{ asset('assets2/images/testimonial/client-06.png') }}" alt="blog-image">
                    </div>
        ...
        <div class="blog-content-wrapper rbt-article-content-wrapper">
            <div class="content">
                <div class="post-thumbnail mb--30 position-relative wp-block-image alignwide">
                    <figure>
                        <img src="{{ asset('assets2/images/blog/blog-single-03.png') }}" alt="Blog Images">
                ...
                <div class="wp-block-gallery columns-3 is-cropped">
                    <ul class="blocks-gallery-grid">
                        <li class="blocks-gallery-item">
                            <figure>
                                <img class="radius-4" src="{{ asset('assets2/images/blog/blog-gallery-01.jpg') }}" alt="Blog Images">
                            </figure>
                        </li>
                        <li class="blocks-gallery-item">
                            <figure>
                                <img class="radius-4" src="{{ asset('assets2/images/blog/blog-gallery-02.jpg') }}" alt="Blog Images">
                            </figure>
                        </li>
                        <li class="blocks-gallery-item">
                            <figure>
                                <img class="radius-4" src="{{ asset('assets2/images/blog/blog-gallery-03.jpg') }}" alt="Blog Images">
                            </figure>
                        </li>
                    </ul>
                </div>
                ...
                <div class="post-thumbnail mb--30 position-relative wp-block-image alignwide">
                    <figure>
                        <img src="{{ asset('assets2/images/blog/blog-bl-02.jpg') }}" alt="Blog Images">
                        <figcaption>Business and core management app are for enterprise.</figcaption>
                    </figure>
                </div>
                ...
                <div class="about-author">
                    <div class="media">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('assets2/images/testimonial/testimonial-4.jpg') }}" alt="Author Images">
                            </a>
                        </div>
                    ...
                    <ul class="comment-list">
                            ...
                            <div class="comment-body">
                                <div class="single-comment">
                                    <div class="comment-img">
                                        <img src="{{ asset('assets2/images/testimonial/testimonial-1.jpg') }}" alt="Author Images">
                                    </div>
                            ...
                            <ul class="children">
                                ...
                                <li class="comment">
                                    <div class="comment-body">
                                        <div class="single-comment">
                                            <div class="comment-img">
                                                <img src="{{ asset('assets2/images/testimonial/testimonial-2.jpg') }}" alt="Author Images">
                                            </div>
                                            <div class="comment-inner">
                                                <h6 class="commenter">
                                                    <a href="#">John Due</a>
                        ...
                        <li class="comment">
                            <div class="comment-body">
                                <div class="single-comment">
                                    <div class="comment-img">
                                        <img src="{{ asset('assets2/images/testimonial/testimonial-3.jpg') }}" alt="Author Images">
                                    </div>
                                    <div class="comment-inner">
                                        <h6 class="commenter">
    ...
    <div class="row g-3">
        <div class="col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="instagram-grid">
                <a href="#">
                    <img src="{{ asset('assets2/images/instagram/instagram-01.jpg') }}" alt="instagram">
                    <span class="user-info">
                    <span class="icon"><i class="icon-instagram"></i></span>
                    <span class="user-name">@ExcellentSchools</span>
                    </span>
                </a>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="instagram-grid">
                <a href="#">
                    <img src="{{ asset('assets2/images/instagram/instagram-02.jpg') }}" alt="instagram">
                    <span class="user-info">
                    <span class="icon"><i class="icon-instagram"></i></span>
                    <span class="user-name">@ExcellentSchools</span>
                    </span>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="instagram-grid">
                <a href="#">
                    <img src="{{ asset('assets2/images/instagram/instagram-03.jpg') }}" alt="instagram">
                    <span class="user-info">
                    <span class="icon"><i class="icon-instagram"></i></span>
                    <span class="user-name">@ExcellentSchools</span>
                    </span>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="instagram-grid">
                <a href="#">
                    <img src="{{ asset('assets2/images/instagram/instagram-04.jpg') }}" alt="instagram">
                    <span class="user-info">
                    <span class="icon"><i class="icon-instagram"></i></span>
                    <span class="user-name">@ExcellentSchools</span>
                    </span>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="instagram-grid">
                <a href="#">
                    <img src="{{ asset('assets2/images/instagram/instagram-05.jpg') }}" alt="instagram">
                    <span class="user-info">
                    <span class="icon"><i class="icon-instagram"></i></span>
                    <span class="user-name">@ExcellentSchools</span>
                    </span>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="instagram-grid">
                <a href="#">
                    <img src="{{ asset('assets2/images/instagram/instagram-06.jpg') }}" alt="instagram">
                    <span class="user-info">
                    <span class="icon"><i class="icon-instagram"></i></span>
                    <span class="user-name">@ExcellentSchools</span>
                    </span>
