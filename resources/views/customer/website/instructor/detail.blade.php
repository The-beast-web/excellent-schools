            ...
            <div class="col-lg-12">
                ...
                <div class="rbt-dashboard-content-wrapper">
                    <div class="tutor-bg-photo bg_image  height-350">
                        <img src="{{ asset('assets2/images/bg/bg-image-22.jpg') }}" alt=""> 
                    </div>
                        ...
                        <div class="col-lg-2 offset-lg-2">
                            <div class="feature-sin best-seller-badge text-end h-100">
                                <span class="rbt-badge-2 w-100 text-center badge-full-height">
                                    <span class="image"><img src="{{ asset('assets2/images/icons/card-icon-1.png') }}" alt="Best Seller Icon"></span> Bestseller
                                </span>
                            </div>
                        </div>
                    </div>
