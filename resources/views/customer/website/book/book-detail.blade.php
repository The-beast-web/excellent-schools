        ...
        <div class="rbt-single-product-area rbt-single-product rbt-section-gap">
            <div class="container">
                <div class="row g-5 row--30 align-items-center">
                    <div class="col-lg-6">
                        <div class="thumbnail">
                            <img class="w-100 radius-10" src="{{ asset('assets2/images/product/1.jpg') }}" alt="Product Images">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-default-card style-three rbt-hover">
                            <div class="inner">
                                ...
                                <div class="thumbnail"><a href="single-product.html"><img src="{{ asset('assets2/images/product/1.jpg') }}" alt="Histudy Book Image"></a></div>
                                <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-default-card style-three rbt-hover">
                            <div class="inner">
                                ...
                                <div class="thumbnail"><a href="single-product.html"><img src="{{ asset('assets2/images/product/7.jpg') }}" alt="Histudy Book Image"></a></div>
                                <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-default-card style-three rbt-hover">
                            <div class="inner">
                                ...
                                <div class="thumbnail"><a href="single-product.html"><img src="{{ asset('assets2/images/product/3.jpg') }}" alt="Histudy Book Image"></a></div>
                                <div class="content">
