                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="page-list">
                            ...
                            <li class="rbt-breadcrumb-item active">Books</li>
                        </ul>
                        <!-- End Breadcrumb Area  -->

                        <div class=" title-wrapper">
                            <h1 class="title mb--0">Books Library</h1>
                        </div>
                ...
                <div class="mesonry-list grid-metro2">
                    ...
                    <div class="maso-item cat--1">
                        <div class="rbt-card variation-01 rbt-hover card-list-2">
                            <div class="rbt-card-img">
                                    <img src="{{ asset('assets2/images/course/course-list-01.jpg') }}" alt="Card image">
                            </div>
                            <div class="rbt-card-body">
                                ...
                                <h4 class="rbt-card-title">React Front To Back
                                </h4>
                                ...
                                <div class="rbt-card-bottom">
                                    ...
                                    <a class="rbt-btn-link left-icon" href="{{ route('website.book-detail') }}"><i
                        ...
                        <div class="rbt-card variation-01 rbt-hover card-list-2">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets2/images/course/course-list-02.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                    ...
                    <div class="maso-item cat--3">
                        <div class="rbt-card variation-01 rbt-hover card-list-2">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets2/images/course/course-list-03.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                                ...
                                <div class="rbt-author-meta mb--20">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="{{ asset('assets2/images/client/avatar-03.png') }}" alt="Sophia Jaymes">
                                        </a>
                                    </div>
                                    <div class="rbt-author-info">
                    ...
                    <div class="maso-item cat--4">
                        <div class="rbt-card variation-01 rbt-hover card-list-2">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets2/images/course/course-list-04.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                                ...
                                <div class="rbt-author-meta mb--20">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="{{ asset('assets2/images/client/avater-01.png') }}" alt="Sophia Jaymes">
                                        </a>
                                    </div>
                                    <div class="rbt-author-info">
                    ...
                    <div class="maso-item cat--1 cat--3">
                        <div class="rbt-card variation-01 rbt-hover card-list-2">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets2/images/course/course-list-05.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                    ...
                    <div class="maso-item cat--2 cat--4">
                        <div class="rbt-card variation-01 rbt-hover card-list-2">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="{{ asset('assets2/images/course/course-list-06.jpg') }}" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
