                    ...
                    <div class="content text-start">
                        ...
                        <div class="d-flex align-items-center mb--20 flex-wrap rbt-course-details-feature">
                            ...
                            <div class="feature-sin best-seller-badge">
                                <span class="rbt-badge-2">
                                    <span class="image"><img src="{{ asset('assets2/images/icons/card-icon-1.png') }}"
                        ...
                        <div class="rbt-author-meta mb--20">
                            <div class="rbt-avater">
                                <a href="#">
                                    <img src="{{ asset('assets2/images/client/avatar-02.png') }}" alt="Sophia Jaymes">
                                </a>
                            </div>
                        ...
                        <div class="rbt-instructor rbt-shadow-box intructor-wrapper mt--30" id="intructor">
                            <div class="about-author border-0 pb--0 pt--0">
                                ...
                                <div class="media align-items-center">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="{{ asset('assets2/images/testimonial/testimonial-7.jpg') }}"
                                                alt="Author Images">
                                        </a>
                                    </div>
                            ...
                            <div class="has-show-more-inner-content rbt-featured-review-list-wrapper">
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('assets2/images/testimonial/testimonial-3.jpg') }}"
                                                    alt="Author Images">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('assets2/images/testimonial/testimonial-4.jpg') }}"
                                                    alt="Author Images">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('assets2/images/testimonial/testimonial-1.jpg') }}"
                                                    alt="Author Images">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('assets2/images/testimonial/testimonial-6.jpg') }}"
                                                    alt="Author Images">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="rbt-course-review about-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <a href="#">
                                                <img src="{{ asset('assets2/images/testimonial/testimonial-8.jpg') }}"
                                                    alt="Author Images">
                                            </a>
                                        </div>
                                        <div class="media-body">
                        ...
                        <div class="row g-5">
                                ...
                                <div class="rbt-card variation-01 rbt-hover">
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
                                            <img src="{{ asset('assets2/images/course/course-online-01.jpg') }}"
                                                alt="Card image">
                                    ...
                                    <div class="rbt-card-body">
                                        ...
                                        <div class="rbt-author-meta mb--10">
                                            <div class="rbt-avater">
                                                <a href="#">
                                                    <img src="{{ asset('assets2/images/client/avatar-02.png') }}"
                                                        alt="Sophia Jaymes">
                                                </a>
                                            </div>
                                            <div class="rbt-author-info">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up"
                                ...
                                <div class="rbt-card variation-01 rbt-hover">
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
                                            <img src="{{ asset('assets2/images/course/course-online-02.jpg') }}"
                                                alt="Card image">
                                        </a>
                                    </div>
                                    <div class="rbt-card-body">
                        ...
                        <div class="inner">
                            ...
                            <a class="video-popup-with-text video-popup-wrapper text-center popup-video sidebar-video-hidden mb--15"
                                ...
                                <div class="video-content">
                                    <img class="w-100 rbt-radius" src="{{ asset('assets2/images/others/video-01.jpg') }}"
                                        alt="Video Images">
                            ...
                            <div class="content-item-content">
                                <div class="buy-now-btn mt--25">
                                    <a class="rbt-btn btn-border icon-hover w-100 d-block text-center" href="{{ route('website.course-checkout') }}">
                                        <span class="btn-text">Start Course $45</span>
                    ...
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <div class="rbt-author-meta mb--20">
                                <div class="rbt-avater">
                                    <a href="#">
                                        <img src="{{ asset('assets2/images/client/avatar-03.png') }}"
                                            alt="Sophia Jaymes">
                                    </a>
                                </div>
                                <div class="rbt-author-info">
                    ...
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <div class="rbt-author-meta mb--20">
                                <div class="rbt-avater">
                                    <a href="#">
                                        <img src="{{ asset('assets2/images/client/avater-01.png') }}"
                                            alt="Sophia Jaymes">
                                    </a>
                                </div>
                                <div class="rbt-author-info">
