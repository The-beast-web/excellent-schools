                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <div class="rbt-card-bottom">
                                        <a class="rbt-btn btn-sm bg-primary-opacity w-100 text-center" href="#">Continue Course</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <div class="rbt-card-bottom">
                                        <a class="rbt-btn btn-sm bg-primary-opacity w-100 text-center" href="{{ route('student.course-lesson') }}">Continue Course</a>
                                    </div>
                                </div>
                            </div>
                        </div>
