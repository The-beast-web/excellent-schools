        ...
        <nav class="side-nav w-100">
            <ul class="rbt-minicart-wrapper">
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="{{ asset('assets2/images/product/1.jpg') }}" alt="Product Images">
                        </a>
                    </div>
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="{{ asset('assets2/images/product/7.jpg') }}" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="{{ asset('assets2/images/product/3.jpg') }}" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="{{ asset('assets2/images/product/4.jpg') }}" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
        ...
        <div class="rbt-minicart-footer">
            ...
            <div class="rbt-minicart-bottom mt--20">
                <div class="view-cart-btn">
                    <a class="rbt-btn btn-border icon-hover w-100 text-center" href="{{ route('website.cart') }}">
                        <span class="btn-text">View Cart</span>
                        <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                    </a>
                </div>
                <div class="checkout-btn mt--20">
                    <a class="rbt-btn btn-gradient icon-hover w-100 text-center" href="{{ route('website.checkout') }}">
