                            ...
                            <div class="card h-100">
                                <div class="nk-ecwg nk-ecwg2">
                                    ...
                                    <div class="nk-ecwg2-ck">
                                        <canvas class="ecommerce-bar-chart-s1"
                                            id="averargeOrder"></canvas>
                                    </div>
                                </div><!-- .nk-ecwg -->
                            </div><!-- .card -->
                        </div><!-- .col -->
                                ...
                                <div class="nk-ecwg nk-ecwg4 h-100">
                                    ...
                                    <div class="card-inner card-inner-md bg-light">
                                        <div class="card-note">
                                            ...
                                            <span>Traffic channels have beed generating the most
                                                traffics over past days.</span>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- .card -->
