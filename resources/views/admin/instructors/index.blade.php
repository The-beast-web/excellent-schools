                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="more-options">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                <a href="{{ route('admin.instructor-request') }}" class="btn btn-icon btn-primary d-md-none"><em
                                                        class="icon ni ni-loader"></em></a>
                                                <a class="btn btn-primary d-none d-md-inline-flex" href="{{ route('admin.instructor-request') }}"><em
                                                        class="icon ni ni-loader"></em><span>Requests</span></a>
                                            </li>
                                            <li class="nk-block-tools-opt">
                                                <a href="{{ route('admin.instructor-payment') }}" class="btn btn-icon btn-primary d-md-none"><em
                                                        class="icon ni ni-cards"></em></a>
                                                <a class="btn btn-primary d-none d-md-inline-flex"
                                                    href="{{ route('admin.instructor-payment') }}"><em
                                                        class="icon ni ni-cards"></em><span>Instructor Payments</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <li class="nk-tb-action-hidden">
                                                        <a href="{{ route('admin.instructor-detail') }}"
                                                            class="btn btn-trigger btn-icon" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="Full Details">
