                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Instructor Payment Detail</h3>
                        ...
                        <div class="nk-block-head-content">
                            <a href="{{ route('admin.instructor-payment') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                            <a href="{{ route('admin.instructor-payment') }}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                        </div>
                    </div>
                </div><!-- .nk-block-head -->
                <div class="nk-block">
                    <div class="invoice">
                        <div class="invoice-action">
                            <a class="btn btn-icon btn-lg btn-white btn-dim btn-outline-primary" href="{{ route('admin.instructor-payment-detail-print') }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Print"><em class="icon ni ni-printer-fill"></em></a>
                        </div><!-- .invoice-actions -->
