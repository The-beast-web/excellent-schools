                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Course Orders</h3>
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col">
                                                <span class="tb-product">
                                                    ...
                                                    <span class="title">JavaScript Full Course</span>
                                                </span>
                                            </div>
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <li class="nk-tb-action-hidden"><a href="#"
                                                            ...
                                                            title="Approve">
                                                            <em class="icon ni ni-check-circle"></em></a></li>
                                                    <li class="nk-tb-action-hidden"><a
                                                            href="#"
                                                            class="btn btn-icon btn-trigger btn-tooltip"
                                                            title="Decline">
                                                            <em class="icon ni ni-cross-circle"></em></a></li>
                                                    <li>
