                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-ulist">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">Books Bought</span>
                                            </div>
                                                ...
                                                <div class="d-lg-flex d-none">
                                                    <div class="drodown">
                                                        <a href="#" class="dropdown-toggle pt-1 text-info"
                                                            data-bs-toggle="dropdown"> <span>View More</span> </a>
                                                        <div class="dropdown-menu dropdown-menu-start">
                                                            <ul class="link-list-opt no-bdr p-3">
                                                                <li class="tb-lead p-1">Application Management</li>
                                                                <li class="tb-lead p-1">Learn Android Development with
                                                                    project</li>
                                                ...
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    <li>
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="html/lms/students-details.html"><em
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-mb">
                                                <span class="tb-lead d-lg-flex d-none">Learn Android Development with
                                                    project </span>
                                                <div class="d-lg-flex d-none">
                                                    <div class="drodown">
                                                        <a href="#" class="dropdown-toggle pt-1 text-info"
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <li class="nk-tb-action-hidden">
                                                        <a href="{{ route('admin.student.detail') }}" class="btn btn-trigger btn-icon"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="View Detail">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <ul class="nk-nav nav nav-tabs mt-n2">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#student-info">Student Infomation</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#address-info">Address & Password</a>
                        </li>
                    </ul><!-- .nav-tabs -->
                    <div class="tab-content">
                        <div class="tab-pane active" id="student-info">
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="display-name">Skill/Occupation</label>
                                        <input type="text" class="form-control" id="display-name"
                                            placeholder="Last name">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="phone-no" value="+880"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control date-picker" id="birth-day"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" name="password" class="form-control form-control-md" id="password" placeholder="Enter your passcode">
                                        </div>
                                    </div>
                                </div>
                            </div>
