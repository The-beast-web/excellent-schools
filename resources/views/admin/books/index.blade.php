            ...
            <div class="nk-content-body">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="#" data-target="addProduct" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Book</span></a>
                                        </li>
                                        <li class="nk-block-tools-opt">
                                            <a href="{{ route('admin.book-orders') }}"  class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-bag"></em></a>
                                            <a href="{{ route('admin.book-orders') }}" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-bag"></em><span>Orders</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="nk-block">
                    <div class="nk-tb-list is-separate mb-3">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col"><span>Word Count</span></div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    ...
                                                    <li><a href="{{ route('admin.book-detail') }}"><em class="icon ni ni-eye"></em><span>View Product</span></a></li>
                ...
                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h5 class="nk-block-title">New Book</h5>
                            <div class="nk-block-des">
                                <p>Add information and add new book.</p>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <div class="nk-block">
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label" for="product-title">Book Title</label>
                                    <div class="form-control-wrap">
                            ...
                            <div class="col-mb-6">
                                <div class="form-group">
                                    <label class="form-label" for="regular-price">Author</label>
                                    <div class="form-control-wrap">
                            ...
                            <div class="col-mb-6">
                                <div class="form-group">
                                    <label class="form-label" for="sale-price">Regular Price</label>
                                    <div class="form-control-wrap">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><em class="ni ni-sign-kobo"></em></span>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label" for="tags">Year</label>
                                    <div class="form-control-wrap">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label" for="tags">Edition (Optional)</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="tags">
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label" for="tags">Premise</label>
                                    <div class="form-control-wrap">
