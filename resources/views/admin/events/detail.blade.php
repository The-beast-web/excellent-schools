            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        ...
                        <div class="nk-block-head-content">
                            <a href="{{ route('admin.event.main') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                            <a href="{{ route('admin.event.main') }}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                        </div>
                    </div>
                </div><!-- .nk-block-head -->
                <div class="nk-block">
                                ...
                                <div class="col-lg-6">
                                    <div class="product-info mt-5 me-xxl-5">
                                        ...
                                        <div class="product-meta">
                                            <ul class="g-3 gx-5">
                                                <li>
                                                    <div class="fs-14px text-muted">Host</div>
                                                    <div class="fs-16px fw-bold text-secondary">The Beastist</div>
                                                </li>
                                                
                                                <li>
                                                    <div class="fs-14px text-muted">Location</div>
                                                ...
                                                <li>
                                                    <div class="fs-14px text-muted">No. of Tickets Sold</div>
                                                    <div class="fs-16px fw-bold text-secondary">1,000</div>
                                                </li>
                                                <li>
