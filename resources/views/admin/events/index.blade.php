                ...
                <div class="nk-content-body">
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                <a href="{{ route('admin.event.orders') }}"
                                                    class="btn btn-icon btn-primary d-md-none"><em
                                                        class="icon ni ni-bag"></em></a>
                                                <a href="{{ route('admin.event.orders') }}"
                    ...
                    <div class="nk-block">
                        <div class="nk-tb-list is-separate mb-3">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col"><span>Host</span></div>
                                <div class="nk-tb-col"><span>Ticket Price</span></div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="#"><em class="icon ni ni-edit"></em><span>Edit
                                                                    Product</span></a></li>
                                                        <li><a href="{{ route('admin.event.detail') }}"><em
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="#"><em class="icon ni ni-edit"></em><span>Edit
                                                                    Product</span></a></li>
                                                        <li><a href="{{ route('admin.course-detail') }}"><em
                                                                    class="icon ni ni-eye"></em><span>View
                                                                    Product</span></a></li>
                                                        <li><a href="#"><em
                                                                    class="icon ni ni-activity-round"></em><span>Product
                    ...
                    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct"
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h5 class="nk-block-title">New Event</h5>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="product-title">Event Title</label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        <label class="form-label" for="regular-price">Host</label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        <label class="form-label" for="sale-price">Ticket Price</label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        <label class="form-label" for="regular-price">Location</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="regular-price">
                                        </div>
                                    </div>
                                ...
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        <label class="form-label" for="stock">Date</label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="tags">Content</label>
